...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">Approved Events</h3> </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active">Approved Events</li>
        </ol>
    </div>
</div>
                            ...
                            <tbody>
                                ...
                                @foreach($events as $e)
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> 
                                            {{ Form::open([
                                                'route' => ['event-unapprove', $e->id],
                                                'method' => 'POST',
                                                'style' => 'display:inline-block'
                                                ]) }}
                                                <button class="btn btn-primary btn-sm"><i class="fa fa-times"></i></button>
                                            {{ Form::close() }}
                                        </td>
                                        <td>
                                            <a href="{{ url('renginiai/' . $e->category->slug . '/' . $e->slug) }}" target="_blank" class="btn btn-success btn-sm"><i class="fas fa-link"></i></a>
