...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">Edit About Us Page</h3> </div>
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="basic-form">
					...
					{!! Form::open(['route' => ['about_us.update', $about_us['id']], 'method' => 'PUT','files' => true]) !!}

						<div class="form-group">
							{!! Form::label('Title', 'Title') !!}
							{!! Form::text('Title', $about_us['Title'], array('class' => 'form-control input-default')) !!}
                        </div>


              <div class="form-group">
							{!! Form::label('Text', 'Text') !!} <span class="text-danger">*</span>
							{!! Form::text('Text', $about_us->Text, array('class' => 'form-control textarea_editor', 'rows' => 15)) !!}
              </div>
                        ...
                        <div class="col-sm-1">
                          <div class="image-container">
                            @if(!empty($about_us['Photo']))
                              <span class="delete-item delete-favicon" data-id="{{ $about_us->id }}">
                                <i class="fa fa-trash"></i>
                              </span>
                              <img src="{{ asset('storage_old/aboutus/' . $about_us['Photo']) }}" width="100%">
                            @endif
                          </div>
                        </div>
