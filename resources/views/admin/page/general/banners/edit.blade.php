...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">Edit banner</h3> </div>
				...
				<div class="basic-form">
					...
					{!! Form::open(['route' => ['banner.update', $banner->id], 'method' => 'PUT', 'files' => true]) !!}
						...
						<div class="form-group">
							...
							{!! Form::text('name', $banner->name, array('class' => 'form-control input-default')) !!}
						</div>
						...
						<div class="form-group">
							...
							{!! Form::text('link', $banner->link, array('class' => 'form-control input-default')) !!}
						</div>
