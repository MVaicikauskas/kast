		...
		<div class="card">
			...
			<div class="card-body">
				<div class="basic-form">
					<h4>Image</h4>
					<br>
					{!! Form::open(['route' => ['gallery.update', $image->id], 'method' => 'PUT', 'files' => true]) !!}

						<div class="form-group">
							{!! Form::label('author', 'Author') !!} <span class="text-danger">*</span>
							{!! Form::text('author', $image->author, array('class' => 'form-control input-default')) !!}
            </div>
            
            @if (!empty($image->image))
            <div class="form-group">
              <img src="{{ asset('storage/gallery/' . $image->image) }}" width="300px">
            </div>
            @endif
