...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">Edit Advertisements Page</h3> </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active">Advertisements Page</li>
        </ol>
    </div>
</div>
...
<div class="row">
	<div class="col-sm-12">
		<div class="card">
          ...
          {!! Form::open(['route' => ['advertisement-page-settings.update', $advertisementPageSettings['id']], 'method' => 'PUT', 'files' => true]) !!}

						<div class="form-group">
							{!! Form::label('Title', 'Title') !!}
							{!! Form::text('Title', $advertisementPageSettings['Title'], array('class' => 'form-control input-default')) !!}
						</div>


            <div class="form-group">
							{!! Form::label('Text', 'Text') !!} <span class="text-danger">*</span>
							{!! Form::text('Text', $advertisementPageSettings->Text, array('class' => 'form-control textarea_editor', 'rows' => 15)) !!}
            </div>
                        ...
                        @endif
							...
							<div class="col-sm-11">
								<div class="form-group">
									...
									{!! Form::file('Photo', array('class' => 'form-control input-default')) !!}
								</div>
							</div>
						</div>
            <!-- End of Image stuff -->
